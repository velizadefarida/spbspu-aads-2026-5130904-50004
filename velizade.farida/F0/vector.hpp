...
template< class T >
void velizade::Vector< T >::pushBack(const T& rhs)
{
  if (size_ >= capacity_)
  {
...
template< class T >
void velizade::Vector< T >::pushFront(const T& t)
{
...
template< class T >
void velizade::Vector< T >::insert(size_t id, const T& rhs)
{
  if (id > size_)
  {
...
template< class T >
void velizade::Vector< T >::insert(size_t id, const Vector< T >& rhs, size_t beg, size_t end)
{
  if (id > size_)
  {
    throw std::out_of_range("insert index out of range");
...
template< class T >
typename velizade::Vector< T >::iterator velizade::Vector< T >::insert(iterator pos, const T& rhs)
{
